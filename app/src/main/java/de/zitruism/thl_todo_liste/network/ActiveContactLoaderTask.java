...
public class ActiveContactLoaderTask extends AsyncTask<Void, Void, ArrayList<Contact>> {
    ...
    public ActiveContactLoaderTask(List<String> ids, DetailViewModel viewModel, IMainActivity mListener) {
        this.ids = ids;
    ...
    protected void onPostExecute(ArrayList<Contact> contacts) {
        ...
        if(viewModel != null){
            viewModel.setTodoContacts(contacts);
        }
    }
}
